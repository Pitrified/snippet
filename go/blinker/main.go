...
func main() {
	...
	case "cellfire":
		...
		// cellfire.StartFire(16, 16, 100, 50_000) // rad 100, 10s in 8s
		cellfire.StartFire(16, 16, 100, 70_000) // rad 50, 10s in 11s
		// cellfire.StartFire(16, 16, 200, 50_000) // rad 50, 10s in 8s, fails
		// cellfire.StartFire(16, 16, 200, 50_000) // rad 100, 10s in 7s, fails
		// cellfire.StartFire(16, 16, 200, 70_000) // rad 100, 10s in 11s
