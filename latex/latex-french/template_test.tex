...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% verbs conjugation with tense and model
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newcommand{\verbconjma}[9]{
\begin{tabular}{rl}
#1 & \MakeUppercase{#2} \\ 
\textit{model} & \textit{#9} \\  
je & \textbf{#3} \\  
...
% column with model, declination only

\newcommand{\verbconjcolma}[8]{
\begin{tabular}{l}
\MakeUppercase{#1} \\ 
\textit{#8} \\  
\textbf{#2} \\  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% table with MFxSP and translations
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
