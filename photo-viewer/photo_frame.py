...
class PhotoFrame(tk.Frame):
    ...
    def move_photo(self, direction):
        ...
        if direction == "right":
            ...
            if self.mov_x + widget_wid > zoom_wid:
                ...
                print("\a", end="")
                print(
                    f'hit {self.format_color(direction, "sandy brown")} border, mov_x = {self.mov_x}'
                )
            ...
            if self.mov_y < 0:
                ...
                print("\a", end="")
                print(
                    f'hit {self.format_color(direction, "sandy brown")} border, mov_y = {self.mov_y}'
                )
    ...
    def move_photo_mouse(self, mouse_x, mouse_y):
        ...
        if self.mov_x + widget_wid > zoom_wid:
            ...
            #  print('\a', end='')
            print(
                f'hit {self.format_color("right", "sandy brown")} border, mov_x = {self.mov_x}'
            )
        ...
        if self.mov_x < 0:
            ...
            #  print('\a', end='')
            print(
                f'hit {self.format_color("left", "sandy brown")} border, mov_x = {self.mov_x}'
            )
        ...
        if self.mov_y < 0:
            ...
            #  print('\a', end='')
            print(
                f'hit {self.format_color("top", "sandy brown")} border, mov_y = {self.mov_y}'
            )
        ...
        if self.mov_y + widget_hei > zoom_hei:
            ...
            #  print('\a', end='')
            print(
                f'hit {self.format_color("down", "sandy brown")} border, mov_y = {self.mov_y}'
            )
    ...
    def change_photo_list(self, new_list):
        ...
        if self.current_photo in new_list:
            ...
            print(
                f"Found {self.current_photo} at index {self.photo_index} in {self.format_color_name(self.frame_name)}"
            )
        else:
            print(
                f"Not found {self.current_photo} in {self.format_color_name(self.frame_name)}, setting photo_index to 0"
            )
            self.photo_index = 0
            self.load_photo()
