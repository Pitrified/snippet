...
class PhotoFrame(tk.Frame):
    ...
    def calc_zoom_level(self):
        ...
        print()
        print(f'calc_zoom_level photo {self.format_color(f"{basename(self.current_photo)}", "blue1")}')
    ...
    def zoom_photo(self, direction, rel_x=-1, rel_y=-1):
        ...
        #  if direction == 'in': pass

        self.mov_x = ( self.mov_x/old_zoom + rel_x/old_zoom - rel_x/zoom) * zoom
        self.mov_y = ( self.mov_y/old_zoom + rel_y/old_zoom - rel_y/zoom) * zoom
    ...
    def do_resize(self, e=None):
        ...
        if self.mov_x + widget_wid > zoom_wid:
            self.mov_x = self.cur_wid - widget_wid
        ...
        if self.mov_y + widget_hei > zoom_hei:
            self.mov_y = self.cur_hei - widget_hei
