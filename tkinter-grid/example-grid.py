...
class InfoLabel(tk.Label):
    def __init__(self, parent, *args, **kwargs):
        ...
        # create a StringVar for the dynamic text
...
class ResizableGrid(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        # create containers
        self.top_frame = tk.Frame(self, bg="light cyan", height=50, pady=3)
        self.center = tk.Frame(self, bg="gray2", padx=3, pady=3)
        self.btm_frame = tk.Frame(self, bg="white", height=45, pady=8)
        self.btm_frame2 = tk.Frame(self, bg="lavender", height=60, pady=3)
        ...
        # ctr_left has no weight, the column does not adjust: set width here
        self.ctr_left = tk.Frame(self.center, bg="blue", width=100)
        self.ctr_mid = tk.Frame(self.center, bg="yellow", padx=3, pady=3)
        self.ctr_right = tk.Frame(self.center, bg="green", width=100, padx=3, pady=3)
        ...
        # bind configure event on ctr_mid frame to the function inside the label
        self.ctr_mid.bind("<Configure>", self.lab1.update)
